...
class KafkaConfig {
    ...
    companion object {
        const val bootstrapServers = "kafka:9092"
    ...
    fun producerFactory(): ProducerFactory<String, String> {
        ...
        configurationProperties[ProducerConfig.BOOTSTRAP_SERVERS_CONFIG] = bootstrapServers
    ...
    fun consumerFactory(): ConsumerFactory<String, String> {
        val configurationProperties = HashMap<String, Any>()
        configurationProperties[ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG] = bootstrapServers
